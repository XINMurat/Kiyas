...
| `skill/kiyas/schemas/kiyas-seed.yaml` | The output contract as data (rules G1–G9, warnings W1–W4) |
| `kiyas.skill` | One-file package for installing the skill |
| `tools/kiyas_validate.py` | LLM-free G1–G9 checker; `--strict` also fails on W1–W4 |
...
G1–G9 seed schema & validator + survival ledger + Mizan feedback loop.
...
| `skill/kiyas/schemas/kiyas-seed.yaml` | Çıktı sözleşmesinin veri hâli (G1–G9 kuralları, W1–W4 uyarıları) |
| `kiyas.skill` | Skill'i kurmak için tek-dosya paket |
| `tools/kiyas_validate.py` | LLM'siz G1–G9 denetleyici; `--strict` W1–W4'te de düşer |
