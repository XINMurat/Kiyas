...
| `skill/kiyas/schemas/kiyas-seed.yaml` | The output contract as data (rules G1–G15, warnings W1–W7) |
| `kiyas.skill` | One-file package for installing the skill |
| `tools/kiyas_validate.py` | LLM-free G1–G15 checker; `--strict` also fails on W1–W7 |
...
non-blocking warning channel (W1–W7, `--strict` in CI), a second worked batch
...
| `skill/kiyas/schemas/kiyas-seed.yaml` | Çıktı sözleşmesinin veri hâli (G1–G15 kuralları, W1–W7 uyarıları) |
| `kiyas.skill` | Skill'i kurmak için tek-dosya paket |
| `tools/kiyas_validate.py` | LLM'siz G1–G15 denetleyici; `--strict` W1–W7'da da düşer |
...
(W1–W7, CI'da `--strict`), ikinci çalışılmış parti (illeti düşen alanlar-arası
