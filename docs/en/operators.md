...
> page; the Turkish mirror is `docs/tr/operatorler.md`.
...
checker is `tools/kiyas_validate.py` (G1–G15, plus non-blocking W1–W7). It verifies that the fields are
