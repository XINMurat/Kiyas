<!-- GENERATED PAGE - do not edit here.
     Source of truth: skill/kiyas/references/recovery.md
     Regenerate:      python tools/sync_en_docs.py
     CI (`--check`) fails if this page drifts from its source. -->

# Recovery — the ramps for when a batch goes wrong
...
**capability** or a **convenience**? Without the validator, G1–G15 were not
