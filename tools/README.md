...
| Tool | What it does |
|---|---|
| `kiyas_validate.py` | Enforces G1–G14 on a seed batch. `--lang tr\|en`, `--refuted <file>` for the AD4 negative-constraint check. Exit 0 clean / 1 violations / 2 usage. |
...
| Araç | Ne yapar |
|---|---|
| `kiyas_validate.py` | Bir tohum partisinde G1–G14'yı uygular. `--lang tr\|en`, AD4 negatif-kısıt kontrolü için `--refuted <dosya>`. Çıkış 0 temiz / 1 ihlal / 2 kullanım. |
